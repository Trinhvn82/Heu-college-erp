    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.RESTRICT, to='info.class')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dept', models.ForeignKey(default=1, on_delete=django.db.models.deletion.RESTRICT, to='info.dept')),
                ('user', models.OneToOneField(null=True, on_delete=django.db.models.deletion.RESTRICT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='info.course')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='info.student')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assign', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='info.assign')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendanceclass', models.ForeignKey(default=1, on_delete=django.db.models.deletion.RESTRICT, to='info.attendanceclass')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='info.course')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='info.student')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('studentcourse', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='info.studentcourse')),
            ],
            options={

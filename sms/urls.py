...
#    path('monhoc/<int:lop_id>/', views.lop_monhoc, name='lop_monhoc'),
    ...
    path('CreateHp81/<int:sv_id>', views.create_hp81, name='create_hp81'),
    path('EditHp81/<int:hp81_id>', views.edit_hp81, name='edit_hp81'),
    path('CreateHs81/<int:sv_id>', views.create_hs81, name='create_hs81'),
    path('EditHs81/<int:hs81_id>', views.edit_hs81, name='edit_hs81'),
